...
type ClientService interface {
	GetV1Ping(params *GetV1PingParams, opts ...ClientOption) (*GetV1PingOK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
GetV1Ping healths check

Returns the pong as response
*/
func (a *Client) GetV1Ping(params *GetV1PingParams, opts ...ClientOption) (*GetV1PingOK, error) {
